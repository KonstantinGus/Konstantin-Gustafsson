...
val monthNames = listOf( //kuukaudet indeksoitu, lista nimistä,
    "Tammi", "Helmi", "Maalis", "Huhti", "Touko", "Kesä", "Heinä", "Elo", "Syys", "Loka", "Marras", "Joulu"
)
class MyAdapter(private val dataSet: List<Month>) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.textViewA.text = monthNames[position] + "kuu:"
