        ...
        if ids is not None and corners is not None:
            for i in range(len(ids)):
                if ids[i][0] == id:
                    ...
                    corner = corners[i][0]
                    vector = corner[2] - corner[3] #joskus kamerasta liittyen pitää käyttää eri kulmia, jos robotti kääntyy 180 pieleen, koita vaihtaa päittäin 2-3 -> 3-2
...
lowerX = 90
upperX = 630
lowerY = 90 #voi tarkistaa ja tweakata riippuen areenasta
upperY = 640
