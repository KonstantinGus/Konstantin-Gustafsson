...
pointOwnGoal = (218, 100) #nää on maalintekoalueiden keskipiste
pointEnemyGoal = (480, 380)
...
frndPointA =(260, 340)
frndPointB = (390, 150) #pitää vaihtaa, random pojot joihin frnd palaa cp 0:ssa

lowerX = 160
upperY = 430
upperX = 535
lowerY = 50 #voi tarkistaa ja tweakata riippuen areenasta
